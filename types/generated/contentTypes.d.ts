...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    products: Attribute.Relation<
      ...
      'api::product.product'
    >;
    sub_sub_categories: Attribute.Relation<
      'api::category.category',
      'manyToMany',
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    image_catalogue: Attribute.Media & Attribute.Required;
    ...
    specification: Attribute.Component<'specifications.product-details', true>;
...
export interface ApiProductUnitProductUnit extends Schema.SingleType {
...
export interface ApiSubSubCategorySubSubCategory extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::sub-sub-category.sub-sub-category', 'name'> &
      Attribute.Required;
    sub_categories: Attribute.Relation<
      'api::sub-sub-category.sub-sub-category',
      'manyToMany',
